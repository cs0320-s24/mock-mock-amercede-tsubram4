const mockedData = new Map<string, string[][]>(); // map holding mocked data

// various arrays to mock different views and searches
const view1 = [
  ["apple", "banana", "cherry"],
  ["dog", "elephant", "fox"],
  ["green", "blue", "red"],
...
const allowedLoadedDirectories = [
  [
    ...
    "data/malformed/malformed_signs.csv",
...
// This function simply returns the mockedData map.
